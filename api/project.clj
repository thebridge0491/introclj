...
(defproject org.sandbox/introclj.practice "0.1.0"
	:description "Practice sub-package for Clojure Intro examples project."
  ...
  :dependencies [;[leiningen/leiningen "2.9.5"]
    ...
    :aot [org.sandbox.introclj.practice.classic org.sandbox.introclj.practice.sequenceops]
    ...
    ;:jar-name "introclj.practice-%s.jar"
    ;:jar-exclusions [#"(?:^|/).svn/"]
