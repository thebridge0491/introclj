...
(defproject org.sandbox/introclj.foreignc "0.1.0"
	:description "FFI sub-package for Clojure Intro examples project."
  ...
  :dependencies [;[leiningen/leiningen "2.9.5"]
    ...
    :aot [org.sandbox.introclj.foreignc.IClassic-c org.sandbox.introclj.foreignc.classic]
    ...
    ;:jar-name "introclj.foreignc-%s.jar"
    ;:jar-exclusions [#"(?:^|/).svn/"]
